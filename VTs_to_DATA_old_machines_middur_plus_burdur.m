...
input_directory = '/Users/grigoriosoikonomou/Documents/Prober_Lab/Videotrackers/analysis_software/analysis2/_csv_input/'; % adapt this to your system
output_directory = '/Users/grigoriosoikonomou/Documents/Prober_Lab/Videotrackers/analysis_software/analysis2/_csv_output/'; % adapt this to your system

files = dir(input_directory);

for i = 4:length(files)
    input_file = files(i).name;
    data = readtable(strcat(input_directory, files(i).name), 'Delimiter', 'tab');
    ...
    writetable(clean_data, strcat(output_directory, output_file), 'Delimiter', '\t');
