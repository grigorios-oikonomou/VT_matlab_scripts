...
genox.genotype_filename = '210726_36_37_genotype_3.txt'; % the name of the genotype file
genox.data_filename = '210726_36_37_kcnk5a_c0449_UTF8_DATA_middur_TRIMMED.txt'; % the name of the data file
...
genox.experiment = strcat(' 210726 VT36 and VT37 kcnk5a (-40) - cutoff = ', num2str(genox.cutoff)); % name of experiment
